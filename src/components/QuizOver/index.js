...
const QuizOver = React.forwardRef((props, ref) => {
    ...
    const hash = '83c003fb9255d574e012057dfdbe8cc5';
    ...
    if(score < averageGrade){
        setTimeout(() => loadLevelQuestions(quizLevel), 4000)
    }
        ...
        <div className="stepsBtnContainer">
            {
                ...
                (
                    <>
                        <p className="successMsg"><BsTrophy size={"50px"}/> Bravo, vous êtes un expert !</p>
